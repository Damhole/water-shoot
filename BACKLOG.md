...
| v63 | Scéna puzzlu z lehkého nadhledu místo ptačí perspektivy — míra nadhledu je jedna konstanta `VIEW` (0,26 → 0,13), podlaha v pozadí skoro nesbíhá. Ořez kapaliny nově kopíruje vykroužené dno válce (dřív obdélník, takže voda měla dole rovnou hranu proti oblouku skla) | — | 2026-08-03 |
