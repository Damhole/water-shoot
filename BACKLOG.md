...
| v78 | Bedny odlétají i DO HLOUBKY, ne jen do stran. Simulace zůstává 2D, každá bedna si nese vlastní posun v ose z, který se promítne do perspektivy (dál = menší, blíž k úběžníku). Voda přilétá od hráče, takže je odhazuje od nás. Vzdálenější se kreslí první, aby je bližší překryly | — | 2026-08-03 |
