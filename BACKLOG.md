...
| v60 | **Pěna s pamětí** — per-částicová hodnota, vzniká při nárazu (skok rychlosti) i rychlým pohybem, nová kapka z proudu je zpěněná, pod hladinou se rozpouští 5x rychleji (jinak byla voda mléčná v celém objemu). Výchozí velikost kapky zpět na 5 px | — | 2026-08-03 |
