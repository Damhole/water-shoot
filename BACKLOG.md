...
| v66 | Výraznější a jasnější modrá — odstín vody vytažen z kódu do `tune.glTint` (laditelný), sytost 0,62 → 0,76. Nad ~0,85 už voda přestává být průhledná, proto mezistupeň | — | 2026-08-03 |
