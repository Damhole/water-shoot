...
| v71 | Pozadí nahrazeno ručně vyretušovaným obrázkem (bez děla) — přemalování v kódu vypnuto, ale zůstalo použitelné pro jiné předlohy. Přidán výběr barvy vody v HUD (input type=color), ukládá se a resetuje spolu se zbytkem nastavení. PNG 2,1 MB převedeno na JPEG 484 kB, originál v assets-src/ | — | 2026-08-03 |
