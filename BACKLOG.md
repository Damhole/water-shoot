...
| v71 | (hash 010a35f) Pozadí nahrazeno ručně vyretušovaným obrázkem (bez děla) — přemalování v kódu vypnuto, ale zůstalo použitelné pro jiné předlohy. Přidán výběr barvy vody v HUD (input type=color), ukládá se a resetuje spolu se zbytkem nastavení. PNG 2,1 MB převedeno na JPEG 484 kB, originál v assets-src/ | — | 2026-08-03 |
| v72 | (hash de7ff50) Napouštěcí otvor přesunut z horní podstavy na PŘEDNÍ stěnu válce jako výřez ve skle (even-odd cesta, ne kolečko navrch) s poloprůhledným bílým lemem. Balistika míří na přední stěnu místo na osu, trefa se testuje jako kruh v rovině x-y. Přepočítána kalibrace přítoku: do otvoru vpředu se míří přímo, takže projde ~95 % částic místo 39 % u otvoru shora (bez toho se válec plnil za 4 s místo 12) | — | 2026-08-03 |
| v73 | (hash 60fd719) **Nádoba ve tvaru U + kachnička jako plovoucí těleso.** Stěny jsou nově seznam úseček (nová úroveň = data, ne kód), kachnička je tuhé těleso nadnášené částicemi, takže v jakémkoli tvaru plave sama. Levé rameno je vyšší než pravé — spojené nádoby se srovnají k nejnižšímu odtoku, takže s otvorem ve stejně vysokém rameni by hladina pravý okraj nikdy nepřeplavila. Kanál dole je poloviční proti kachničce, aby neproplouvala zpět. Hladina se měří po ramenech zvlášť | — | 2026-08-03 |
| v74 | (hash c2490c9) Kachnička se nepřetáčí — těžiště sníženo pod střed tvaru (kruh ho měl přesně ve středu, takže nevznikal vzpřimovací moment), k tomu tlumení rotace, pružina k nule a tvrdý strop náklonu 29°. Ověřeno rozhoupáním gravitací ±20°: maximum 28,6°, mezi vlnami se vrací k nule | — | 2026-08-03 |
| v75 | Pozadí puzzlu vyměněno za kreslenou variantu (styl konečně sedí s hrou, ne jen barvy). Fotorealistická zůstala jako `bg_puzzle_foto.jpg`, PNG 2 MB → JPEG 476 kB | 2bdaba4 | 2026-08-03 |
| v76 | (hash 062fa22) **Úroveň 2: pyramida z beden** (rozdělané) — přepínání úrovní `?level=1|2` a tlačítka v HUD, každá úroveň samostatný modul se stejným rozhraním. Bedny jsou tuhá tělesa s výdrží, kreslená jako fake-3D krychle. Fyzika a kresba stojí, ale bourání nefunguje: proud dopadá 80-115 px pod pyramidu a bedny propadávají podlahou | — | 2026-08-03 |
| v77 | (hash 0e52816) Úroveň 2 přepsána: bedny stojí na bidle, dělo je nerozbíjí, jen do nich strká, a rozbijí se samy dopadem na zem. Odpadla tím celá kalibrace poškození. Zrušeno třepání obrazovkou i podmínka se sundáním kachničky; kachnička z levelu 2 pryč. Podlaha je tlustý blok a bedny mají spojitou detekci kolizí, aby nepropadávaly | — | 2026-08-03 |
| v78 | (hash f23e94f) Bedny odlétají i DO HLOUBKY, ne jen do stran. Simulace zůstává 2D, každá bedna si nese vlastní posun v ose z, který se promítne do perspektivy (dál = menší, blíž k úběžníku). Voda přilétá od hráče, takže je odhazuje od nás. Vzdálenější se kreslí první, aby je bližší překryly | — | 2026-08-03 |
| v79 | (hash 09864dd) Bedny letí po SKUTEČNÉM směru kapky (nahoru a od hráče), ne uměle do stran podle poloviny obrazu — naměřeno: zdvih 96 px, hloubka na strop 320, do stran jen 35 px. Bedna, která odletí za bidlo, se odpojí od 2D fyziky a dopad si dopočítá sama, jinak by vizuálně letěla vzad, ale fyzikálně dopadla zpět na bidlo | — | 2026-08-03 |
| v80 | (hash e66fad7) **Hloubka jako plnohodnotná souřadnice.** Box2D počítá boční pohled, osu z si vede scéna sama (bez gravitace, jen setrvačnost a odpor). Podpory mají hloubkový rozsah, takže pád za bidlo je fyzikální důsledek, ne prahová podmínka. Bedny nově stojí ve dvou hloubkových řadách — každá je vlastní kolizní vrstva (categoryBits), jinak by 2D fyzika stavěla přední řadu na zadní | — | 2026-08-03 |
| v81 | (hash 3e2e95f) Věž zvětšena na 40 beden (5 pater, 2 hloubkové řady, bidlo delší o polovinu) a bedny mají materiály: dřevo a kámen v poměru hmotností 8,5:1. Shoditelnost vychází z fyziky (těžší se při stejném impulzu pohne míň), nikde se nezařizuje zvlášť | — | 2026-08-03 |
| v82 | (hash 6bf07d7) Skleněná bedna s kachničkou doprostřed přední řady — po dopadu praskne a kachnička se osvobodí (velký šplouch, nápis, odplouvá). Sklo je třetí materiál (hustota 0,9, průhledné s odleskem). Celá věž i bidlo zvětšeny o třetinu | — | 2026-08-03 |
| v83 | (hash fa14a32) Odštěpky z beden při zásahu (nesou barvu materiálu — z kamene šedé úlomky, ze dřeva třísky), při rozbití celá sprška. **Fix pořadí kreslení:** bedna odstřelená za bidlo se kreslila přes něj a vypadala, že padá před ním — vše se nově řadí podle hloubky včetně bidla | — | 2026-08-03 |
| v84 | (hash 7c82156) Získání kachničky jako oznámení hráči: po prasknutí skla vylétne od místa dopadu pod skóre, chvíli se ukáže ve větším se zlatou září a pak se zhroutí do sebe. Kreslí se v souřadnicích obrazovky, ne scény | — | 2026-08-03 |
| v85 | (hash 8bc26c4) **Fix ujíždění věže:** pyramida se spárami se rozjížděla vlastní vahou (30 px doprava za první vteřinu). Patra mají nově stejnou paritu počtu, takže bedny stojí přímo nad sebou a nemají co roztlačovat — posun klesl na 3 px za 15 s. K tomu víc iterací řešiče, tlumení beden a usazení věže před startem kola. Rozbití bedny nově roztříštění na čtyři kusy, prachový prstenec a sprška třísek | — | 2026-08-03 |
| v86 | (hash 218be02) Úlomky z rozbitých beden jsou prosté kostičky bez detailů bedny (s horní stěnou a obrysem se v malém četly jako mini bedny) a mizí zhruba dvakrát rychleji — 0,32–0,55 s místo 0,7–1,2 s | — | 2026-08-03 |
| v87 | (hash 284e8f2) **Fix zpomalené vody na slabším zařízení.** Krok kapaliny se ořezával na 1/50 s, takže při 10 FPS se svět posunul jen o pětinu skutečného času a voda tekla 5x pomaleji (na telefonu jako med). Uplynulý čas se nově dělí na kroky po 1/60 se stropem 0,1 s. Ověřeno: kapka spadne za 1 s o 476 px při 60, 30, 15 i 10 FPS stejně | — | 2026-08-03 |
| v88 | (hash a356888) **Fix rozprsknuté vody z v87.** Dělení kroku ukrajovalo po 1/60 a zbytek simulovalo jako mikro-krok — reálný 60Hz snímek má 16,8 ms, zbylo 0,13 ms a řešič dělí 1/dt: naměřeno 75 000 px/s proti normálním 600, voda jako mlha a kachnička vykopnutá. Nově stejně dlouhé podkroky (max 0,02 s), žádný zbytek. Ověřeno: max rychlost 585–600 a stejná hladina při 120–10 FPS | — | 2026-08-03 |
| v89 | (hash df9373e) **Fix „vroucí" hladiny a potopené kachničky.** Řešič částic běžel s 1 iterací — tlak ve sloupci vody se nestíhal vyrovnat, voda se věčně stlačovala a vystřelovala (120 px/s ještě 10 s po zastavení přítoku) a vztlak v tom zmatku nefungoval. Nově 3 iterace: klidová rychlost 13–32 px/s, kachnička jede celou dobu na hladině (~40 px nad úrovní), hladina stoupá rychleji (nestlačuje se). Výkon stejný (0,54 ms/krok) | — | 2026-08-03 |
| v90 | (hash 1fc6ef8) Voda v úzkém rameni už neleze „bez gravitace" přes kachničku: vypnuto povrchové napětí částic (tensile) — částice se přitahovaly, dělaly slepené chuchvalce, hromadily se nad kachničkou a stahovaly k sobě další vodu, až ji potopily (max nad kachničkou 68 → 39 kapek). K tomu měkký doraz náklonu kachničky místo tvrdého SetTransform (zaklíněná kmitala tam a zpět) a spojitá detekce kolizí i pro plovoucí tělesa | — | 2026-08-03 |
| v91 | (hash 357a282) **Fix „nahé" stuhy za nádobou.** Uzly stuhy proudu měly kolize jen na kachničky ve střelnici — v puzzlu proletěly nádobou i bednami a stuha se kreslila dál, zatímco částice už umřely. Úrovně nově odpovídají na dotaz `blocksSpine`. Ověřeno: při míření na sklo dolétne nejhlubší uzel na 573 (stěna 610), do otvoru projde na 709 | — | 2026-08-03 |
| v92 | (hash 7a96fbe) Špička stuhy proudu se zužuje do ztracena přes poslední 4 uzly. Končila tupým klínem plné šířky, zatímco kapky kolem řídly — proto z konce proudu „couhal" holý ocásek. Délka byla přitom v pořádku: naměřeno přes 340 snímků, medián −2 px, max +7 px | — | 2026-08-03 |
| v93 | (hash cd80a31) Dopad proudu na nádobu i bedny je konečně VIDĚT — kroužek a šplouchnutí vznikaly jen na zadní stěně a podlaze střelnice, v puzzlu byl náraz němý. Stuha navíc projde otvorem jen kousek za jeho rovinu (dřív letěla přes celý vnitřek nádoby, takže z otvoru couhal ocásek) | — | 2026-08-03 |
| v94 | (hash 9fd520e) Delší dráha vody bez posouvání cíle — hlavní pákou je hloubka ústí děla (70 → −260 prodlouží dráhu na obrazovce z 596 na 1140 px). Posuvníky: vzdálenost objektu, rychlost proudu, délka dráhy vody. Změřeno, že rychlost proudu délku NEmění (596/600 px), jen hustotu vody v letu; pod −350 se hroutí perspektiva | — | 2026-08-03 |
| v95 | (hash 4b68f8b) **Revert posunu ústí děla z v94.** Dělo se kreslí na pevném místě obrazovky, ale voda vzniká ve světě a promítá se — posunutí ústí na −260 ji nechalo začínat v měřítku 1,77, takže proud byl tlustší a vyjížděl zpod hlavně. Ústí zpět na 70, posuvník odstraněn. Zůstávají opravy z v93 (kroužky, šplouchnutí, ocásek z otvoru) | — | 2026-08-03 |
| v96 | (hash b2864e5) **Dokončení revertu v94** — zůstala tam snížená výchozí rychlost proudu (1500 → 1050), takže během náběhu trysky voda viditelně nedoletěla. Naměřeno: po 0,3 s doletí při 1050 na 206, při 1500 na 423; plného doletu dosáhne 1050 až po 1,2 s místo 0,6 s. Vráceno na 1500 | — | 2026-08-03 |
| v97 | Špička stuhy už nevykukuje před kapky — koncový uzel se zahazuje. Naměřeno: stuha předbíhala nejvzdálenější kapku o 14 jednotek hloubky, po zahození uzlu končí 1–6 px ZA kapkami (medián −6) | — | 2026-08-03 |
